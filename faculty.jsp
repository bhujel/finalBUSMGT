<%-- 
    Document   : faculty
    Created on : 30 Mar, 2019, 3:30:39 PM
    Author     : birendra
--%>
...
<body>
    ...
    <section class="sec2">
        <div class="mid">
            <div class="sub1" style="background-color:rgb(131, 163, 173)">
            ...
            <div class="sub1" style="background-color:purple">
            ...
            <div class="sub1" style="background-color:red">
